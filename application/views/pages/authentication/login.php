...
<marquee style="font-size: 20px"> Competion to begin on the 28th! Till then we are testing our servers. Visit us on <a href="https://www.facebook.com/CodeCracker.Mukti/">Facebook</a> for more updates!</marquee>
<?php echo form_open('login') ?>
	<div class="box login">

		<div class="judge_logo">
			<a href="<?php echo site_url() ?>">
                            <img src="<?php echo base_url("assets/images/lug_logo.png") ?>" width="80px" height="80px" style="float: left;"/>
                            <img src="<?php echo base_url("assets/images/cc_black.png") ?>" width="250px" height="90px" style="float: right;"/>
                        </a>
		</div>
