...
<div id="main_container" class="scroll-wrapper">
    <div class="scroll-content">
        ...
        <div id="main_content">
            ...
            <?php elseif ($this->user_model->get_user_level($username) < 2 && $now < strtotime($assignment['start_time'])): ?>
                <p>Selected round has not started.</p>
            <?php elseif ($this->user_model->get_user_level($username) < 2 && $now > strtotime($assignment['finish_time']) + $assignment['extra_time']): // deadline = finish_time + extra_time?>
