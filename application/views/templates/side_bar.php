...
//A bad practice to use models in view, but I've to do it since I need it in every page
//$notification_count = $this->notifications_model->have_new_notification($this->assignment['start_time']);
...
<div id="side_bar" class="sidebar_open">
	<ul>
		...
		<?php endif ?>
                ...
                <li <?php echo ($selected=='notifications'?'class="selected"':'') ?>><a href="<?php echo site_url('notifications') ?>"><i class="splashy-comment_reply"></i>
                        <span class="sidebar_text">Notifications <!--<span style="color: #EE5555; font-size: 10px; float: right; margin-right: 5px"><?php echo $notification_count ?> new</span>--></span></a>
                </li>
